...
export const ChannelBarChart: React.FC<ChannelChartProps> = ({ channels }) => {
  const getChannelColor = (platform: string) => {
    switch (platform) {
      ...
      case 'TikTok Ads': return '#FE2C55';
      case 'LinkedIn Ads': return '#0A66C2';
      case 'Email Marketing': return '#8B5CF6';
      default: return darkTheme.primary;
    }
  };
...
const styles = StyleSheet.create({
  card: { backgroundColor: darkTheme.cardBg, borderRadius: 16, padding: 16, borderWidth: 1.5, borderColor: darkTheme.surfaceBorder, marginBottom: 12 },
