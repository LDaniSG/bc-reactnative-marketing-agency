          ...
          <View>
            ...
            <View style={styles.statsBanner}>
              <View style={styles.statCol}>
                ...
                <Text style={styles.statLbl}>Cuentas</Text>
              </View>
              <View style={styles.divider} />
              <View style={styles.statCol}>
                <Text style={styles.statVal}>$120K</Text>
                <Text style={styles.statLbl}>Inv. Mensual</Text>
              </View>
            </View>
        ...
        renderItem={({ item }) => (
          <View style={styles.card}>
            ...
            <View style={styles.contactRow}>
              ...
              >
                <Text style={styles.actionBtnText}>📧 Enviar Correo</Text>
              </TouchableOpacity>
            </View>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  statsBanner: { flexDirection: 'row', backgroundColor: darkTheme.surface, borderRadius: 16, paddingVertical: 14, borderWidth: 1.5, borderColor: darkTheme.surfaceBorder, marginBottom: 14 },
  statCol: { flex: 1, alignItems: 'center' },
  statVal: { fontSize: 18, fontWeight: '800', color: darkTheme.primary },
  statLbl: { fontSize: 11, fontWeight: '700', color: darkTheme.textMuted, marginTop: 2 },
  divider: { width: 1, backgroundColor: darkTheme.surfaceBorder },
  searchWrapper: { marginBottom: 14 },
  searchInput: { backgroundColor: darkTheme.surface, borderWidth: 1.5, borderColor: darkTheme.surfaceBorder, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 10, fontSize: 14, color: darkTheme.textPrimary },
  card: { backgroundColor: darkTheme.surface, borderRadius: 18, padding: 16, marginBottom: 14, borderWidth: 1.5, borderColor: darkTheme.surfaceBorder },
  ...
  industryTag: { backgroundColor: '#EEF2FF', alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, marginTop: 4 },
  ...
  contactRow: { flexDirection: 'row', gap: 8, marginTop: 14, paddingTop: 12, borderTopWidth: 1, borderTopColor: '#E0E7FF' },
  actionBtn: { flex: 1, backgroundColor: '#EEF2FF', paddingVertical: 8, paddingHorizontal: 10, borderRadius: 10, alignItems: 'center' },
