...
const styles = StyleSheet.create({
  ...
  bannerWrapper: { position: 'relative', marginBottom: 16, borderRadius: 18, overflow: 'hidden', borderWidth: 1.5, borderColor: darkTheme.surfaceBorder },
  heroBanner: { width: '100%', height: 180 },
  statusChip: { position: 'absolute', top: 12, left: 12, backgroundColor: 'rgba(16, 185, 129, 0.95)', paddingHorizontal: 12, paddingVertical: 5, borderRadius: 20 },
  statusChipText: { color: '#FFF', fontSize: 11, fontWeight: '800' },
  client: { color: darkTheme.secondary, fontSize: 13, fontWeight: '700', textTransform: 'uppercase' },
  title: { color: darkTheme.textPrimary, fontSize: 22, fontWeight: '800', marginTop: 4, marginBottom: 6 },
  objectiveBadge: { color: darkTheme.textSecondary, fontSize: 14, marginBottom: 16 },
  budgetCard: { backgroundColor: darkTheme.surface, borderRadius: 16, padding: 16, borderWidth: 1.5, borderColor: darkTheme.surfaceBorder, marginBottom: 20 },
  budgetRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  budgetLabel: { color: darkTheme.textSecondary, fontSize: 13, fontWeight: '600' },
  budgetValue: { color: darkTheme.textPrimary, fontSize: 13, fontWeight: '800' },
  progressBarBg: { height: 10, backgroundColor: '#E0E7FF', borderRadius: 6, overflow: 'hidden' },
  progressBarFill: { height: '100%', borderRadius: 6 },
  progressText: { marginTop: 6, fontSize: 12, color: darkTheme.textMuted, fontWeight: '600' },
  sectionTitle: { fontSize: 16, fontWeight: '800', color: darkTheme.textPrimary, marginBottom: 12 },
  metricGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginBottom: 16 },
  metricBox: { width: '47%', backgroundColor: darkTheme.surface, padding: 14, borderRadius: 16, borderWidth: 1.5, borderColor: darkTheme.surfaceBorder },
  metricBoxAccent: { borderColor: '#A5F3FC', backgroundColor: '#F0FDFA' },
  metricBoxSuccess: { borderColor: '#A7F3D0', backgroundColor: '#ECFDF5' },
  boxEmoji: { fontSize: 18, marginBottom: 4 },
  boxLabel: { color: darkTheme.textMuted, fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
  boxValue: { color: darkTheme.textPrimary, fontSize: 18, fontWeight: '800', marginTop: 4 },
});